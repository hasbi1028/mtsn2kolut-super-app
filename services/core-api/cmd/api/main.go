...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		r.With(requireCbt).Get("/api/cbt/questions/{id}/timeline", questionH.Timeline)
		...
		r.With(requireCbt).Get("/api/cbt/non-test-assessments", nonTestAssessmentH.List)
		r.With(requireCbt).Post("/api/cbt/non-test-assessments", nonTestAssessmentH.Create)
		r.With(requireCbt).Get("/api/cbt/non-test-assessments/{id}", nonTestAssessmentH.Get)
		...
		r.With(requireCbt).Post("/api/cbt/non-test-assessments/{id}/sync-grade", nonTestAssessmentH.SyncGrade)
		...
		r.With(requireAdmin).Put("/api/cbt/events/{id}/members/{member_id}", eventH.UpdateMember)
		r.With(requireAdmin).Delete("/api/cbt/events/{id}/members/{member_id}", eventH.DeleteMember)
		r.With(requireCbt).Get("/api/cbt/events/{id}/question-targets", eventH.ListQuestionTargets)
		r.With(requireAdmin).Put("/api/cbt/events/{id}/question-targets", eventH.UpsertQuestionTarget)
		r.With(requireAdmin).Delete("/api/cbt/events/{id}/question-targets/{subject_id}", eventH.DeleteQuestionTarget)
		...
		r.With(requireCbt).Get("/api/bank-soal/questions/summary", questionH.Summary)
		r.With(requireCbt).Get("/api/bank-soal/questions", questionH.List)
		r.With(requireCbt).Post("/api/bank-soal/questions", questionH.Create)
		r.With(requireCbt).Patch("/api/bank-soal/questions/bulk-workflow", questionH.BulkWorkflowAction)
		r.With(requireCbt).Get("/api/bank-soal/questions/export", questionH.ExportCSV)
		r.With(requireCbt).Get("/api/bank-soal/questions/template", questionH.TemplateCSV)
		r.With(requireCbt).Post("/api/bank-soal/questions/import-legacy", questionH.ImportLegacyCSV)
		r.With(requireCbt).Get("/api/bank-soal/questions/{id}", questionH.Get)
		r.With(requireCbt).Get("/api/bank-soal/questions/{id}/timeline", questionH.Timeline)
		r.With(requireCbt).Put("/api/bank-soal/questions/{id}", questionH.Update)
		r.With(requireCbt).Post("/api/bank-soal/questions/{id}/duplicate", questionH.Duplicate)
		r.With(requireCbt).Post("/api/bank-soal/questions/{id}/revision", questionH.MarkRevision)
		r.With(requireCbt).Patch("/api/bank-soal/questions/{id}/workflow", questionH.WorkflowAction)
		r.With(requireCbt).Delete("/api/bank-soal/questions/{id}", questionH.Delete)
		r.With(requireCbt).Get("/api/bank-soal/assets", questionAssetH.List)
		r.With(requireCbt).Post("/api/bank-soal/assets", questionAssetH.Upload)
		...
		r.With(requireAdmin).Post("/api/asesmen/packages", packageH.Create)
		r.With(requireAdmin).Delete("/api/asesmen/packages/{id}", packageH.Delete)
		r.With(requireCbt).Get("/api/asesmen/events", eventH.List)
		r.With(requireAdmin).Post("/api/asesmen/events", eventH.Create)
		...
		r.With(requireAdmin).Put("/api/asesmen/events/{id}/members/{member_id}", eventH.UpdateMember)
		r.With(requireAdmin).Delete("/api/asesmen/events/{id}/members/{member_id}", eventH.DeleteMember)
		r.With(requireCbt).Get("/api/asesmen/events/{id}/question-targets", eventH.ListQuestionTargets)
		r.With(requireAdmin).Put("/api/asesmen/events/{id}/question-targets", eventH.UpsertQuestionTarget)
		r.With(requireAdmin).Delete("/api/asesmen/events/{id}/question-targets/{subject_id}", eventH.DeleteQuestionTarget)
		r.With(requireAdmin).Get("/api/asesmen/events/{id}/results", eventH.GetResults)
		r.With(requireAdmin).Get("/api/asesmen/events/{id}/exam-cards", eventH.GetExamCards)
		r.With(requireAdmin).Put("/api/asesmen/events/{id}", eventH.Update)
		r.With(requireAdmin).Patch("/api/asesmen/events/{id}/status", eventH.UpdateStatus)
		r.With(requireAdmin).Delete("/api/asesmen/events/{id}", eventH.Delete)
		r.With(requireCbt).Get("/api/asesmen/sessions", sessionH.GuruAwareList)
		r.With(requireAdmin).Post("/api/asesmen/sessions", sessionH.Create)
		...
		r.With(requireAdmin).Patch("/api/asesmen/sessions/{id}/status", sessionH.UpdateStatus)
		r.With(requireAdmin).Patch("/api/asesmen/sessions/{id}/schedule", sessionH.UpdateSchedule)
		r.With(requireAdmin).Delete("/api/asesmen/sessions/{id}", sessionH.Delete)
		r.With(requireCbt).Get("/api/asesmen/sessions/{id}/participants", sessionH.GuruAwareParticipants)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/enroll", sessionH.Enroll)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/enroll-grade", sessionH.EnrollGrade)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/enroll-school", sessionH.EnrollSchool)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/generate-tokens", sessionH.GenerateTokens)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/participants/{pid}/regenerate-token", sessionH.RegenerateToken)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/participants/{pid}/reset-access", sessionH.ResetParticipantAccess)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/participants/{pid}/seat", sessionH.AssignSeat)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/seats/auto", sessionH.AutoAssignSeats)
		r.With(requireCbt).Get("/api/asesmen/sessions/{id}/rooms", sessionH.ListRooms)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/rooms", sessionH.CreateRoom)
		...
		r.With(requireCbt).Put("/api/asesmen/sessions/{id}/rooms/{rid}/proctors", sessionH.ReplaceRoomProctors)
		r.With(requireCbt).Delete("/api/asesmen/sessions/{id}/rooms/{rid}", sessionH.DeleteRoom)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/shuffle-rooms", sessionH.ShuffleRooms)
		r.With(requireCbt).Get("/api/asesmen/sessions/{id}/minutes", sessionH.GetMinutes)
		r.With(requireCbt).Post("/api/asesmen/sessions/{id}/score", sessionH.ScoreSession)
		r.With(requireCbt).Get("/api/asesmen/sessions/{id}/results", sessionH.GuruAwareResults)
		r.With(requireAdmin).Get("/api/asesmen/sessions/{id}/item-analysis", sessionH.GetItemAnalysis)
		...
		r.With(requireAdmin).Get("/api/asesmen/sessions/{id}/proctoring", sessionH.GetProctoringStatus)
		r.With(requireAdmin).Get("/api/asesmen/sessions/{id}/proctoring/events", sessionH.ListParticipantEvents)
		r.With(requireAdmin).Post("/api/asesmen/sessions/{id}/participants/{pid}/flag", sessionH.FlagParticipant)
		r.With(requireAdmin).Post("/api/asesmen/sessions/{id}/participants/{pid}/force-submit", sessionH.ForceSubmitParticipant)
