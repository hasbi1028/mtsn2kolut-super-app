...
func main() {
	...
	cbtPackageSvc := service.NewCbtPackage(pool)
	...
	cbtPackageH := handler.NewCbtPackage(cbtPackageSvc, q)
	cbtEventH := handler.NewCbtEvent(cbtEventSvc)
	cbtSessionH := handler.NewCbtSession(cbtSessionSvc, q)
	assessmentExamH := handler.NewAssessmentExam(assessmentExamSvc)
	questionReportH := handler.NewBankSoalReport(questionReportSvc)
	bankSoalReviewerScopeH := handler.NewBankSoalReviewerScope(bankSoalReviewerScopeSvc)
	...
	requireBankSoalAssignReviewer := mw.RequireAnyPermissionOrRole([]string{"bank_soal.assign_reviewer", "bank_soal.settings"}, "admin")
	requireAsesmenRead := mw.RequireAnyPermissionOrRole([]string{"asesmen.read", "asesmen.manage"}, "admin", "guru", "staf")
	requireAsesmenManage := mw.RequireAnyPermissionOrRole([]string{"asesmen.manage"}, "admin", "guru")
	requireAsesmenCards := mw.RequireAnyPermissionOrRole([]string{"asesmen.cards_issue", "asesmen.manage"}, "admin")
	...
	r.Group(func(r chi.Router) {
		...
		r.With(requireBankSoalRead).Get("/api/cbt/questions/reports", questionReportH.Get)
		r.With(requireBankSoalRead).Get("/api/cbt/questions/reports/export", questionReportH.Export)
		r.With(requireBankSoalRead).Post("/api/cbt/questions/reports/export", questionReportH.Export)
		...
		r.With(requireBankSoalRead).Get("/api/cbt/questions/{id}/workflow-events", questionH.WorkflowEvents)
		...
		r.With(requireBankSoalRead).Get("/api/bank-soal/questions/reports", questionReportH.Get)
		r.With(requireBankSoalRead).Get("/api/bank-soal/questions/reports/export", questionReportH.Export)
		r.With(requireBankSoalRead).Post("/api/bank-soal/questions/reports/export", questionReportH.Export)
		...
		r.With(requireBankSoalRead).Get("/api/bank-soal/questions/{id}/workflow-events", questionH.WorkflowEvents)
		...
		r.With(requireBankSoalAssignReviewer).Get("/api/bank-soal/reviewer-scopes", bankSoalReviewerScopeH.List)
		r.With(requireBankSoalAssignReviewer).Post("/api/bank-soal/reviewer-scopes", bankSoalReviewerScopeH.Upsert)
		r.With(requireBankSoalAssignReviewer).Put("/api/bank-soal/reviewer-scopes", bankSoalReviewerScopeH.Upsert)
		r.With(requireBankSoalAssignReviewer).Delete("/api/bank-soal/reviewer-scopes/{id}", bankSoalReviewerScopeH.Delete)

		// Asesmen/CBT web-first exam foundation — native kegiatan/ujian contract.
		r.With(requireAsesmenRead).Get("/api/asesmen/exams", assessmentExamH.List)
		r.With(requireAsesmenManage).Post("/api/asesmen/exams", assessmentExamH.Create)
		r.With(requireAsesmenRead).Get("/api/asesmen/exams/{id}", assessmentExamH.Get)
		r.With(requireAsesmenManage).Put("/api/asesmen/exams/{id}", assessmentExamH.Update)
		r.With(requireAsesmenRead).Get("/api/cbt/events/{id}/sessions", cbtEventH.ListSessions)
		r.With(requireAsesmenRead).Get("/api/asesmen/exams/{id}/sessions", cbtEventH.ListSessions)
		r.With(requireAsesmenRead).Get("/api/cbt/sessions", cbtSessionH.List)
		r.With(requireAsesmenRead).Get("/api/asesmen/sessions", cbtSessionH.List)
		r.With(requireAsesmenRead).Get("/api/cbt/sessions/{id}", cbtSessionH.Get)
		r.With(requireAsesmenRead).Get("/api/asesmen/sessions/{id}", cbtSessionH.Get)
		r.With(requireAsesmenManage).Post("/api/cbt/sessions", cbtSessionH.Create)
		r.With(requireAsesmenManage).Post("/api/asesmen/sessions", cbtSessionH.Create)
		r.With(requireAsesmenManage).Patch("/api/cbt/sessions/{id}/status", cbtSessionH.UpdateStatus)
		r.With(requireAsesmenManage).Patch("/api/asesmen/sessions/{id}/status", cbtSessionH.UpdateStatus)
		r.With(requireAsesmenManage).Patch("/api/cbt/sessions/{id}/schedule", cbtSessionH.UpdateSchedule)
		r.With(requireAsesmenManage).Patch("/api/asesmen/sessions/{id}/schedule", cbtSessionH.UpdateSchedule)
		r.With(requireAsesmenManage).Delete("/api/cbt/sessions/{id}", cbtSessionH.Delete)
		r.With(requireAsesmenManage).Delete("/api/asesmen/sessions/{id}", cbtSessionH.Delete)
		r.With(requireAsesmenManage).Post("/api/cbt/sessions/{id}/finalize-overdue", cbtSessionH.FinalizeOverdue)
		r.With(requireAsesmenManage).Post("/api/asesmen/sessions/{id}/finalize-overdue", cbtSessionH.FinalizeOverdue)
		r.With(requireAsesmenManage).Post("/api/asesmen/exams/{id}/prepare-rooms", assessmentExamH.PrepareRooms)
		r.With(requireAsesmenManage).Post("/api/asesmen/exams/{id}/assignment-preview", assessmentExamH.AssignmentPreview)
		r.With(requireAsesmenManage).Post("/api/asesmen/exams/{id}/assignment-apply", assessmentExamH.AssignmentApply)
		r.With(requireAsesmenManage).Get("/api/asesmen/exams/{id}/participants", assessmentExamH.ListParticipantPlacements)
		r.With(requireAsesmenManage).Patch("/api/asesmen/exams/{id}/participants/seat", assessmentExamH.MoveParticipantSeat)
		r.With(requireAsesmenManage).Get("/api/asesmen/exams/{id}/package-maps", assessmentExamH.ListPackageMaps)
		r.With(requireAsesmenManage).Post("/api/asesmen/exams/{id}/package-maps", assessmentExamH.SavePackageMaps)
		r.With(requireAsesmenManage).Delete("/api/asesmen/exams/{id}/package-maps/{mapID}", assessmentExamH.DeletePackageMap)
		r.With(requireAsesmenRead).Get("/api/asesmen/package-options", assessmentExamH.ListPackageOptions)
		r.With(requireAsesmenRead).Get("/api/asesmen/packages", cbtPackageH.List)
		r.With(requireAsesmenManage).Post("/api/asesmen/packages", cbtPackageH.Create)
		r.With(requireAsesmenRead).Get("/api/asesmen/packages/{id}", cbtPackageH.Get)
		r.With(requireAsesmenManage).Put("/api/asesmen/packages/{id}", cbtPackageH.Update)
		r.With(requireAsesmenManage).Put("/api/asesmen/packages/{id}/questions", cbtPackageH.ReplaceQuestions)
		r.With(requireAsesmenManage).Post("/api/asesmen/packages/{id}/clone", cbtPackageH.Clone)
		r.With(requireAsesmenManage).Post("/api/asesmen/packages/{id}/lock", cbtPackageH.Lock)
		r.With(requireAsesmenManage).Delete("/api/asesmen/packages/{id}", cbtPackageH.Delete)
		r.With(requireAsesmenManage).Post("/api/asesmen/packages/{id}/archive", cbtPackageH.Archive)
		r.With(requireAsesmenCards).Get("/api/asesmen/exams/{id}/cards", assessmentExamH.ListParticipantCards)
		r.With(requireAsesmenCards).Post("/api/asesmen/exams/{id}/issue-cards", assessmentExamH.IssueCards)
