...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		r.With(requireCbtRead).Get("/api/cbt/packages", cbtPackageH.List)
		r.With(requireCbtManage).Post("/api/cbt/packages", cbtPackageH.Create)
		r.With(requireCbtRead).Get("/api/cbt/packages/{id}", cbtPackageH.Get)
		r.With(requireCbtManage).Put("/api/cbt/packages/{id}", cbtPackageH.Update)
		r.With(requireCbtManage).Put("/api/cbt/packages/{id}/questions", cbtPackageH.ReplaceQuestions)
		r.With(requireCbtManage).Post("/api/cbt/packages/{id}/clone", cbtPackageH.Clone)
		r.With(requireCbtManage).Post("/api/cbt/packages/{id}/lock", cbtPackageH.Lock)
		r.With(requireCbtManage).Delete("/api/cbt/packages/{id}", cbtPackageH.Delete)
		r.With(requireCbtManage).Post("/api/cbt/packages/{id}/archive", cbtPackageH.Archive)
