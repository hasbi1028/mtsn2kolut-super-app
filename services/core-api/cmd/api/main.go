...
func main() {
	...
	cbtPortalSvc := service.NewCbtPortal(q)
	cbtAccessCardSvc := service.NewCbtAccessCard(q)
	...
	approvalSvc := service.NewCbtApproval(q)
	...
	cbtPortalH := handler.NewCbtPortal(cbtPortalSvc, examSvc, mustEnv("JWT_SECRET"))
	cbtAccessCardH := handler.NewCbtAccessCard(cbtAccessCardSvc, mustEnv("JWT_SECRET")).WithProctorPortalSessionService(sessionSvc)
	...
	approvalH := handler.NewCbtApproval(approvalSvc)
	...
	cbtPortalLoginRateLimit := ratelimit.RateLimitWithTrustedProxies(20, 0.2, trustedProxies)
	...
	r.With(cbtPortalLoginRateLimit).Post("/api/exam/portal/card/verify", cbtAccessCardH.VerifyParticipantCard)
	r.With(cbtPortalLoginRateLimit).Post("/api/exam/portal/card/verify/{token}", cbtAccessCardH.VerifyParticipantCard)
	r.With(cbtPortalLoginRateLimit).Post("/api/exam/proctor/card/verify", cbtAccessCardH.VerifyProctorCard)
	r.With(cbtPortalLoginRateLimit).Post("/api/exam/proctor/card/verify/{token}", cbtAccessCardH.VerifyProctorCard)
	r.With(cbtPortalLoginRateLimit).Post("/api/exam/proctor/portal/dashboard", cbtAccessCardH.ProctorPortalDashboard)
	r.With(cbtPortalLoginRateLimit).Post("/api/exam/proctor/portal/status", cbtAccessCardH.ProctorPortalUpdateStatus)
	...
	r.Group(func(r chi.Router) {
		...
		r.With(requireAsesmenProctor).Post("/api/student-id-cards/scan/cbt", studentIDCardH.CBTValidate)
		...
		r.With(requireCbt).Get("/api/cbt/readiness", eventH.Readiness)
		r.With(requireCbt).Get("/api/cbt/events/{id}/overview", eventH.Overview)
		r.With(requireCbt).Get("/api/cbt/events/{id}/sop-readiness", eventH.SopReadiness)
		r.With(requireCbt).Get("/api/cbt/events/{id}/sop", eventH.SopDetail)
		r.With(requireCbt).Get("/api/cbt/events/{id}/transitions", eventH.ListSopTransitions)
		r.With(requireAsesmenEventManage).Post("/api/cbt/events/{id}/transition", eventH.TransitionSop)
		r.With(requireCbt).Get("/api/cbt/events/{id}/readiness", eventH.Readiness)
		...
		r.With(requireCbt).Get("/api/cbt/approvals", approvalH.List)
		r.With(requireAdmin).Post("/api/cbt/approvals", approvalH.Approve)
		r.With(requireAdmin).Post("/api/cbt/approvals/{id}/revoke", approvalH.Revoke)
		...
		r.With(requireAdmin).Post("/api/cbt/sessions/{id}/finalize-overdue", sessionH.FinalizeOverdue)
		r.With(requireCbt).Get("/api/cbt/sessions/{id}/results", sessionH.GuruAwareResults)
		r.With(requireAsesmenResultRead).Get("/api/cbt/sessions/{id}/grade-sync-preflight", sessionH.GetGradeSyncPreflight)
		r.With(requireAsesmenResultRead).Get("/api/cbt/sessions/{id}/remedial-candidates", sessionH.ListRemedialCandidates)
		...
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/proctoring/events", sessionH.ListParticipantEvents)
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/proctoring/live-summary", sessionH.GetProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/proctoring/stream", sessionH.StreamProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/proctoring/report-data", sessionH.GetProctoringReportData)
		r.With(requireCbtOps).Post("/api/cbt/proctoring/events/{event_id}/acknowledge", sessionH.AcknowledgeProctorEvent)
		...
		r.With(requireCbtOps).Post("/api/cbt/sessions/{id}/participants/{pid}/proctor-actions", sessionH.ExecuteProctorAction)
		...
		r.With(requireCbtOps).Patch("/api/cbt/sessions/{id}/rooms/{rid}/web-fallback", sessionH.UpdateRoomWebFallbackPolicy)
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/rooms/{rid}/proctoring/live-summary", sessionH.GetRoomProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/rooms/{rid}/proctoring/stream", sessionH.StreamRoomProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/cbt/sessions/{id}/rooms/{rid}/proctoring/report-data", sessionH.GetRoomProctoringReportData)
		...
		r.With(requireCbt).Get("/api/asesmen/events/{id}/sop-readiness", eventH.SopReadiness)
		r.With(requireCbt).Get("/api/asesmen/events/{id}/sop", eventH.SopDetail)
		r.With(requireCbt).Get("/api/asesmen/events/{id}/transitions", eventH.ListSopTransitions)
		r.With(requireAsesmenEventManage).Post("/api/asesmen/events/{id}/transition", eventH.TransitionSop)
		r.With(requireCbt).Get("/api/asesmen/events/{id}/readiness", eventH.Readiness)
		...
		r.With(requireAdmin).Get("/api/asesmen/events/{id}/exam-access-cards", cbtAccessCardH.ListParticipantCards)
		r.With(requireAdmin).Post("/api/asesmen/events/{id}/exam-access-cards/issue", cbtAccessCardH.IssueParticipantCards)
		r.With(requireAdmin).Get("/api/asesmen/events/{id}/supervisor-access-cards", cbtAccessCardH.ListProctorCards)
		r.With(requireAdmin).Post("/api/asesmen/events/{id}/supervisor-access-cards/issue", cbtAccessCardH.IssueProctorCards)
		...
		r.With(requireCbt).Get("/api/asesmen/approvals", approvalH.List)
		r.With(requireAdmin).Post("/api/asesmen/approvals", approvalH.Approve)
		r.With(requireAdmin).Post("/api/asesmen/approvals/{id}/revoke", approvalH.Revoke)
		...
		r.With(requireAdmin).Post("/api/asesmen/sessions/{id}/finalize-overdue", sessionH.FinalizeOverdue)
		r.With(requireCbt).Get("/api/asesmen/sessions/{id}/results", sessionH.GuruAwareResults)
		r.With(requireAsesmenResultRead).Get("/api/asesmen/sessions/{id}/grade-sync-preflight", sessionH.GetGradeSyncPreflight)
		r.With(requireAsesmenResultRead).Get("/api/asesmen/sessions/{id}/remedial-candidates", sessionH.ListRemedialCandidates)
		...
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/proctoring/events", sessionH.ListParticipantEvents)
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/proctoring/live-summary", sessionH.GetProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/proctoring/stream", sessionH.StreamProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/proctoring/report-data", sessionH.GetProctoringReportData)
		r.With(requireCbtOps).Post("/api/asesmen/proctoring/events/{event_id}/acknowledge", sessionH.AcknowledgeProctorEvent)
		...
		r.With(requireCbtOps).Post("/api/asesmen/sessions/{id}/participants/{pid}/proctor-actions", sessionH.ExecuteProctorAction)
		...
		r.With(requireCbtOps).Patch("/api/asesmen/sessions/{id}/rooms/{rid}/web-fallback", sessionH.UpdateRoomWebFallbackPolicy)
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/rooms/{rid}/proctoring/live-summary", sessionH.GetRoomProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/rooms/{rid}/proctoring/stream", sessionH.StreamRoomProctoringLiveSummary)
		r.With(requireCbtOps).Get("/api/asesmen/sessions/{id}/rooms/{rid}/proctoring/report-data", sessionH.GetRoomProctoringReportData)
