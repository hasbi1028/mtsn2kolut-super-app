...
func main() {
	...
	requireAssessmentRead := mw.RequireAnyPermissionOrRole([]string{"asesmen.read", "asesmen.manage"}, "admin", "guru", "staf")
	requireAssessmentManage := mw.RequireAnyPermissionOrRole([]string{"asesmen.manage"}, "admin", "guru")
	requireAssessmentCardsIssue := mw.RequireAnyPermissionOrRole([]string{"asesmen.cards_issue", "asesmen.manage"}, "admin")
	...
	r.Group(func(r chi.Router) {
		...
		r.With(requireAssessmentRead).Get("/api/asesmen/exams", assessmentExamH.List)
		r.With(requireAssessmentManage).Post("/api/asesmen/exams", assessmentExamH.Create)
		r.With(requireAssessmentRead).Get("/api/asesmen/exams/{id}", assessmentExamH.Get)
		r.With(requireAssessmentManage).Patch("/api/asesmen/exams/{id}", assessmentExamH.Update)
		...
		r.With(requireAssessmentRead).Get("/api/asesmen/packages/options", assessmentExamH.ListPackageOptions)
		r.With(requireAssessmentManage).Get("/api/asesmen/exams/{id}/package-maps", assessmentExamH.ListPackageMaps)
		r.With(requireAssessmentManage).Put("/api/asesmen/exams/{id}/package-maps", assessmentExamH.SavePackageMaps)
		r.With(requireAssessmentManage).Delete("/api/asesmen/exams/{id}/package-maps/{mapID}", assessmentExamH.DeletePackageMap)
