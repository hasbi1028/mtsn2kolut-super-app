...
func main() {
	...
	governanceH := handler.NewGovernance(governanceSvc)
	documentCycleH := handler.NewDocumentCycle(documentCycleSvc)
	kesiswaanH := handler.NewKesiswaan(kesiswaanSvc)
	studentCertificateH := handler.NewStudentCertificate(studentCertificateSvc)
	archiveH := handler.NewArchive(archiveSvc)
	...
	r.Group(func(r chi.Router) {
		...
		r.Put("/api/kesiswaan/students/{id}/profile", kesiswaanH.UpdateStudentProfile)
		r.Post("/api/kesiswaan/students/{id}/photo", kesiswaanH.UploadStudentPhoto)
		...
		r.Post("/api/kesiswaan/violation-categories", kesiswaanH.CreateCategory)
		r.Put("/api/kesiswaan/violation-categories/{id}", kesiswaanH.UpdateCategory)
		r.Delete("/api/kesiswaan/violation-categories/{id}", kesiswaanH.DeleteCategory)
		r.Get("/api/kesiswaan/violations", kesiswaanH.ListViolations)
		r.Post("/api/kesiswaan/violations", kesiswaanH.CreateViolation)
		r.Put("/api/kesiswaan/violations/{id}", kesiswaanH.UpdateViolation)
		r.Delete("/api/kesiswaan/violations/{id}", kesiswaanH.DeleteViolation)
		r.Get("/api/kesiswaan/achievements", kesiswaanH.ListAchievements)
		r.Post("/api/kesiswaan/achievements", kesiswaanH.CreateAchievement)
		r.Put("/api/kesiswaan/achievements/{id}", kesiswaanH.UpdateAchievement)
		r.Delete("/api/kesiswaan/achievements/{id}", kesiswaanH.DeleteAchievement)
		r.Get("/api/kesiswaan/extracurriculars", kesiswaanH.ListExtracurriculars)
		r.Post("/api/kesiswaan/extracurriculars", kesiswaanH.CreateExtracurricular)
		r.Put("/api/kesiswaan/extracurriculars/{id}", kesiswaanH.UpdateExtracurricular)
		r.Delete("/api/kesiswaan/extracurriculars/{id}", kesiswaanH.DeleteExtracurricular)
		r.Get("/api/kesiswaan/extracurricular-members", kesiswaanH.ListExtracurricularMembers)
		r.Post("/api/kesiswaan/extracurricular-members", kesiswaanH.CreateExtracurricularMember)
		r.Put("/api/kesiswaan/extracurricular-members/{id}", kesiswaanH.UpdateExtracurricularMember)
		r.Delete("/api/kesiswaan/extracurricular-members/{id}", kesiswaanH.DeleteExtracurricularMember)
		r.Get("/api/kesiswaan/counseling-sessions", kesiswaanH.ListCounselingSessions)
		r.Post("/api/kesiswaan/counseling-sessions", kesiswaanH.CreateCounselingSession)
		r.Put("/api/kesiswaan/counseling-sessions/{id}", kesiswaanH.UpdateCounselingSession)
		r.Delete("/api/kesiswaan/counseling-sessions/{id}", kesiswaanH.DeleteCounselingSession)
		r.Get("/api/kesiswaan/student-transfers", kesiswaanH.ListStudentTransfers)
		r.Post("/api/kesiswaan/student-transfers", kesiswaanH.CreateStudentTransfer)
