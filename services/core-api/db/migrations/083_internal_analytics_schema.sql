...
CREATE TABLE IF NOT EXISTS internal_analytics_events (
  ...
  CONSTRAINT chk_internal_analytics_events_group CHECK (event_group IN ('public', 'auth', 'dashboard', 'bank_soal', 'asesmen', 'pusaka', 'users', 'rbac', 'security')),
...
CREATE TABLE IF NOT EXISTS internal_analytics_daily_aggregates (
  ...
  CONSTRAINT chk_internal_analytics_daily_aggregates_group CHECK (event_group IN ('public', 'auth', 'dashboard', 'bank_soal', 'asesmen', 'pusaka', 'users', 'rbac', 'security')),
