...
func (q *Queries) RevokeActiveProctorAccessCards(ctx context.Context, roomProctorID pgtype.UUID) error {
	_, err := q.db.Exec(ctx, revokeActiveProctorAccessCards, roomProctorID)
	return err
}
