...
func serializeQuestionListRow(row db.ListCbtQuestionsFilteredRow, includeAnswerKey ...bool) map[string]any {
	...
	return map[string]any{
		...
		"workflow_status":        row.WorkflowStatus,
		"version":                row.Version,
		"version_group_id":       pgUUIDString(row.VersionGroupID),
		"version_number":         row.VersionNumber,
		"source_question_id":     pgUUIDString(row.SourceQuestionID),
		"supersedes_question_id": pgUUIDString(row.SupersedesQuestionID),
...
func serializeQuestionModel(row db.CbtQuestion) map[string]any {
	...
	return map[string]any{
		...
		"version_note":           row.VersionNote,
		"author_username":        row.AuthorUsername,
		"author_display_name":    row.AuthorUsername,
		"reviewer_username":      row.ReviewerUsername,
		"reviewer_display_name":  row.ReviewerUsername,
		"reviewed_at":            row.ReviewedAt,
		"approver_username":      row.ApproverUsername,
		"approver_display_name":  row.ApproverUsername,
		"approved_at":            row.ApprovedAt,
		"writer_notes":           row.WriterNotes,
		"review_notes":           row.ReviewNotes,
	}
...
func serializeQuestionVersionRow(row db.ListCbtQuestionVersionsRow) map[string]any {
	return map[string]any{
		"id":                     pgUUIDString(row.ID),
		"code":                   row.Code,
		"workflow_status":        row.WorkflowStatus,
