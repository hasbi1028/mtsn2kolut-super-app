...
<div class="space-y-6">
	<section class="rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-lime-50 p-6 shadow-sm">
		<div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
			...
			<div class="flex flex-wrap gap-2">
				...
				{/if}
				<a href={resolve('/asesmen')} class="inline-flex items-center rounded-md border border-green-200 bg-white px-3 py-2 text-sm font-semibold text-green-800 hover:bg-green-50">Beranda CBT</a>
	...
	<details class="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm">
		...
		<div class="mt-3 space-y-3 leading-6">
			...
			{/if}
			<a href={resolve('/bank-soal')} class="inline-flex rounded-md border border-green-200 bg-green-50 px-3 py-2 text-sm font-semibold text-green-800 hover:bg-green-100">Buka Bank Soal</a>
		</div>
	</details>
