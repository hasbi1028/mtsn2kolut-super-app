				...
				<div class="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 py-4">
					...
					<section class="rounded-xl border border-emerald-200 bg-emerald-50/60 p-4">
						<div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
							<div><p class="text-xs font-semibold tracking-[0.16em] text-emerald-700 uppercase">Step 6 · Ruang & Peserta</p><h3 class="text-base font-bold text-foreground">Preview dan simpan pembagian ruang</h3><p class="mt-1 text-xs leading-5 text-muted-foreground">Pilih rombel, cek kapasitas, lalu simpan. Kartu/QR+PIN belum diterbitkan.</p></div>
						...
						<div class="mt-4 grid gap-3 sm:grid-cols-3">
							...
							<label class="space-y-1"><span class="text-xs font-medium text-muted-foreground">Mode campur</span><select class="w-full rounded-md border bg-background px-3 py-2 text-sm" bind:value={mixPolicy}><option value="mixed">Campur rombel</option><option value="class_grouped">Kelompok kelas</option></select></label>
						</div>
