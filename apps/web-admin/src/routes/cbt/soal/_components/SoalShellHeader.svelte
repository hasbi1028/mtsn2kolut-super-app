...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
	<div class="flex items-center gap-3 border-b border-slate-100 px-5 py-2.5 text-xs">
		<a href={resolve('/cbt/bank-soal')} class="text-slate-500 hover:text-slate-700">← Beranda Bank Soal</a>
	...
	<div class="grid gap-4 p-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
		<div class="min-w-0">
			<p class="text-xs font-bold uppercase tracking-[0.18em] text-emerald-700">Bank Soal & Asesmen</p>
