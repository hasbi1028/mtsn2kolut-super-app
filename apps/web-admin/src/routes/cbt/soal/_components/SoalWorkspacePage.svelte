<script lang="ts">
	...
	type WorkspaceRoute = '/cbt/bank-soal' | '/cbt/soal' | '/cbt/soal/import' | '/cbt/soal/review';
	...
	function moduleRoute(mode: ModuleMode): WorkspaceRoute {
		if (mode === 'catalog') return '/cbt/bank-soal';
		if (mode === 'review') return '/cbt/soal/review';
		if (mode === 'import') return '/cbt/soal/import';
		return '/cbt/soal';
	}
	...
	function reviewFocusHref(): '/cbt/soal/review' {
