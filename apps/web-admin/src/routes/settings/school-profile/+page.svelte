...
<div class="space-y-6">
	<div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
		<div>
			<h1 class="text-lg font-semibold text-base-content">Profil Madrasah</h1>
			<p class="text-sm text-base-content/70">Identitas resmi untuk kop surat, paket cetak, dan tanda tangan kepala madrasah.</p>
		</div>
		...
		<div class="grid gap-6 xl:grid-cols-[1fr_380px]">
			...
			<div class="space-y-6">
				...
				<Card.Root class="border-base-300">
					...
					<Card.Content>
						<div class="rounded-md border border-base-300 bg-base-100 p-5 text-center text-base-content">
