<script lang="ts">
	...
	const infoPanelClass = 'rounded-lg bg-muted/30 p-4';
	const compactPanelClass = 'rounded-lg bg-muted/30 px-4 py-3 text-sm text-muted-foreground';
