...
describe('SvelteKit handle auth gate', () => {
	...
	const roleCases = [
		...
		{ path: '/asesmen/kegiatan/event-1', roles: ['guru'], allowed: true, api: false },
		...
		{ path: '/api/asesmen/events/event-1', roles: ['guru'], allowed: true, api: true },
		...
		{ path: '/asesmen/kegiatan/event-1/members', roles: ['guru'], allowed: true, api: false },
		...
		{ path: '/asesmen/paket', roles: ['guru'], allowed: true, api: false },
		{ path: '/asesmen/sesi', roles: ['guru'], allowed: true, api: false },
		{ path: '/api/asesmen/packages', roles: ['guru'], allowed: true, api: true, method: 'GET' },
		{ path: '/api/asesmen/packages', roles: ['guru'], allowed: false, api: true, method: 'POST' },
		{ path: '/api/asesmen/sessions', roles: ['guru'], allowed: true, api: true, method: 'GET' },
		...
		{ path: '/api/bank-soal/questions', roles: ['guru'], allowed: true, api: true, method: 'GET' },
