...
describe('admin breadcrumb resolver', () => {
	...
	it('keeps Asesmen fallback breadcrumbs after the standalone Paket Soal group', () => {
		expect(buildAdminBreadcrumbs('/asesmen/kegiatan/01000000-0000-0000-0000-000000000000', adminRoles, adminPermissions)).toEqual([
			{ label: 'Asesmen', href: undefined, section: '8' },
			{ label: 'Persiapan', href: '/asesmen/persiapan', section: '8.1' },
			{ label: 'Kegiatan Asesmen', href: '/asesmen/kegiatan', section: '8.1.1' },
			{ label: 'Detail Kegiatan', href: undefined, section: '8.1.1.1' }
		]);
	});
	...
	it('extends numbered breadcrumbs for detail pages across modules', () => {
		...
		expect(buildAdminBreadcrumbs('/library/books/abc123/copies', adminRoles, adminPermissions)).toEqual([
			{ label: 'Aset & Layanan', href: undefined, section: '10' },
			{ label: 'Perpustakaan', href: undefined, section: '10.1' },
			{ label: 'Katalog Buku', href: '/library/books', section: '10.1.2' },
			{ label: 'Abc123', href: undefined, section: '10.1.2.1' },
			{ label: 'Eksemplar', href: undefined, section: '10.1.2.1.1' }
		]);
	});
	...
	it('keeps numbered context for other major modules', () => {
		...
		expect(buildAdminBreadcrumbs('/tu/surat-keterangan/42/print', adminRoles, adminPermissions)).toEqual([
			{ label: 'Tata Usaha', href: undefined, section: '9' },
			{ label: 'Persuratan', href: undefined, section: '9.1' },
			{ label: 'Surat Keterangan', href: '/tu/surat-keterangan', section: '9.1.4' },
			{ label: 'Detail', href: undefined, section: '9.1.4.1' },
			{ label: 'Cetak', href: undefined, section: '9.1.4.1.1' }
		]);

		expect(buildAdminBreadcrumbs('/website/posts/berita-madrasah/edit', adminRoles, adminPermissions)).toEqual([
			{ label: 'Website', href: undefined, section: '11' },
			{ label: 'Kelola Konten', href: undefined, section: '11.1' },
			{ label: 'Kelola Berita', href: '/website/posts', section: '11.1.7' },
			{ label: 'Berita Madrasah', href: undefined, section: '11.1.7.1' },
			{ label: 'Ubah', href: undefined, section: '11.1.7.1.1' }
		]);
	});
	...
	it('uses global sidebar numbering even when the current role cannot see that menu item', () => {
		expect(buildAdminBreadcrumbs('/pusaka/summary', ['guru'], [])).toEqual([
			{ label: 'Pegawai & Kehadiran', href: undefined, section: '12' },
			{ label: 'PUSAKA', href: undefined, section: '12.2' },
			{ label: 'Ringkasan Kehadiran', href: undefined, section: '12.2.4' }
		]);
	});
