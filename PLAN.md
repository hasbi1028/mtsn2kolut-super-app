...
- [ ] Buat rekap handover tingkat event/sesi: daftar ruang sudah/belum dikunci, ruang bermasalah, insiden, dan submit akhir untuk kepala madrasah/panitia.
- [ ] Bentuk register insiden CBT yang menggabungkan telemetry proctoring, flag pengawas, force submit, reset akses, dan catatan manual handover.
- [ ] Tambahkan arsip/export handover ruang ke print pack atau berita acara final agar bukti digital bisa dicetak/diunduh.
- [ ] Tambahkan rekonsiliasi pasca-sesi: peserta hadir, submit normal, force submit, tidak submit, absen/no-show, dan anomali perangkat per ruang.
- [ ] Perkuat bank soal setelah operasional stabil dengan blueprint coverage matrix CP/TP/KD dan analisis butir pasca-ujian.
