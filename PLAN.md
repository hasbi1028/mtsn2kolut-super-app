...
- [x] Unit-test coverage for `ExamApiClient` envelope unwrap, token-header transport, missing-data failure, malformed JSON mapping, and backend message extraction precedence
