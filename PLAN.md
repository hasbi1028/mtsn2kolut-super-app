...
- [ ] Tidak menghidupkan kembali UI `/cbt/questions`; tambahkan tipe secara bertahap langsung di `/cbt/soal` sambil menjaga kontrak backend `/api/cbt/questions/*`.
