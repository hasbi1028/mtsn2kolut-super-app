...
- [x] Migration `060_cbt_exam_token_hardening.sql` wajib dijalankan di luar jam ujian aktif karena token lama akan diganti dan kartu ujian perlu dicetak ulang.
...
- [ ] Jalankan migration 060 pada staging terlebih dahulu, cetak ulang kartu ujian, lalu lakukan rehearsal login Flutter dengan beberapa perangkat berbeda.
