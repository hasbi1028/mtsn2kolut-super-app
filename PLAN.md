...
- [x] Tabel desktop dan kartu mobile sekarang menampilkan aksi cepat pada badge jadwal: `Batalkan` untuk draft/terjadwal lewat jadwal, `Selesaikan` untuk sesi aktif lewat jadwal, dan `Buka Detail` sebagai fallback.
