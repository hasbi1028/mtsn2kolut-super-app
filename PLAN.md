...
- [x] Unit-test coverage for `ExamApiClient` envelope unwrap, token-header transport, answer/event outbound payload contracts, missing-data failure, malformed/non-object JSON mapping, transport-failure mapping, and backend message extraction precedence
