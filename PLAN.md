...
- [x] Modal komposer `/cbt/soal` merapikan Template Cepat menjadi pilihan chip bergaya modul baru agar metadata dan editor utama lebih cepat terlihat tanpa mengubah fungsi template.
